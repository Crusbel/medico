                                ...
                                <div class="col l6 m6">
                                    <div class="row">
                                        <div class="diente">
                                            <div class="fractura">
                                                <!-- Dropdown Trigger -->
                                                <a class='dropdown-button' href='#' data-activates='diente18'><img src="img/18.png" class="responsive-img"> </a>

                                                <!-- Dropdown Structure -->
                                                <ul id='diente18' class='dropdown-content'>
                                                    <li><a href="#!">Fractura</a></li>
                                                    <li><a href="#!">Extracción</a></li>
                                                    <li><a href="#!">Ausente</a></li>
                                                    <li><a href="#!">Restauración</a></li>
                                                    <li><a href="#!">Caries</a></li>
                                                    <li><a href="#!">Infección pulpar</a></li>
                                                    <li><a href="#!">Endodoncia</a></li>
                                                    <li><a href="#!">Corona</a></li>
                                                    <li><a href="#!">Implante</a></li>
                                                    <li><a href="#!">Perno muñon</a></li>
                                                    <li><a href="#!">Otro</a></li>
                                                </ul> 
                                            </div>
                                            <div class="dienteRestauracion">
                                                <div class="flex"> 
                                                    <div class="rest0"></div>
                                                    <div class="rest restTop"></div>
                                                    <div class="rest0"></div>
                                                </div>
                                                <div class="flex">
                                                    <div class="rest restLeft"></div>
                                                    <div class="rest restCenter"></div>
                                                    <div class="rest restRight"></div>
                                                </div>
                                                <div class="flex">
                                                    <div class="rest0"></div>
                                                    <div class="rest restBottom"></div>
                                                    <div class="rest0"></div>
                                                </div>
                                            </div>
                                            <div class="dienteNumero">
                                                <p>18</p>
                                            </div>
                                        </div>
                                        <div class="diente">
